...
import (
	...
	// Ensure "go mod tidy" doesn't remove the github.com/Kasama/golang-x-crypto module
	// dependency, which is necessary to access the field.Element type.
	_ "github.com/Kasama/golang-x-crypto/curve25519"
)

//go:generate go run . -out ../fe_amd64.s -stubs ../fe_amd64.go -pkg field

func main() {
	Package("github.com/Kasama/golang-x-crypto/curve25519/internal/field")
